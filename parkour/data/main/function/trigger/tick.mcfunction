...
execute as @a[scores={onlysprint=1..}] unless score @s onlysprint_enabled matches 1 at @s run tellraw @s [{"text": "OnlySprint模式已启用.","color": "gray"}]
...
execute as @a[scores={onlysprint=1..}] if score @s onlysprint_enabled matches 1 at @s run tellraw @s [{"text": "OnlySprint模式已禁用.","color": "gray"}]
