...
execute as @a[scores={reset_pb=1..}] run tellraw @s [{"text": "Your PB has been reset.","color": "gray"}]
...
execute as @a if score @s tools matches 1.. if entity @s[tag=tools] run tellraw @s [{"text": "Hotbar tools have been hidden.","color": "gray"}]
...
execute as @a if score @s tools matches 1.. if entity @s[tag=!tools,tag=!tools_hide] run tellraw @s [{"text": "Hotbar tools have been displayed.","color": "gray"}]
